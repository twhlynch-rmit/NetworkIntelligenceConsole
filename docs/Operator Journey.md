...
*Sources: Telstra RMIT Capstone Brief v2, Sprint 1 Requirements Baseline (Aditya Barot), Outage API v1.1.0, Loss of Connectivity API v0.8.0.*

*Labelling key: CONFIRMED (stated in brief/spec/BA doc) · INFERRED · ASSUMPTION · NEEDS VALIDATION*
...
*Depends on the queue-vs-single-incident open question below — if answered "single incident only," this level does not apply.*
